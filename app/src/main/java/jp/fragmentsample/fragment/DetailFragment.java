...
public class DetailFragment extends ListFragment implements TabHost.OnTabChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter0 = new InfoListAdapter(activity, DummyGenerator.getInfoList());//Info
		//adapter1 = new ItemListAdapter(activity, DummyGenerator.getItemShapeList());//Related
		//、、adapter2 = new LabelListAdapter(activity, DummyGenerator.getLabelList());//Tag
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		DebugLog.i("headerLabel"+headerLabel);
