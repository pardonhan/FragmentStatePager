 ...
 *      单项选择模块
 */
public class SpecialTypeSingleActivity extends BaseActivity{
    ...
    private void getExamData() {
        if(m_Dialog!=null){
            ...
            m_Dialog = MsgUtil.ShowLoadDialog(SpecialTypeSingleActivity.this, "请稍后","正在加载数据...");
        }
        new Thread() {
            @Override
            public void run() {
                ...
                _List = DataBaseUtils.getRandomQuestionInfo(SpecialTypeSingleActivity.this, type_id, exam_type);
                if (_List.size() > 0) {
