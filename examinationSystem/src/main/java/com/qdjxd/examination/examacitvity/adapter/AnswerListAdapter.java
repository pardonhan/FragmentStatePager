...
public class AnswerListAdapter extends BaseAdapter {
        ...
        if (answerInfo.itemvalue.contains(A)) {
            ...
            if (questionInfo.selectAnswer.contains(A)) {
                ...
                if (questionInfo.answer.contains(A) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_a_n_day), null, null, null);
                }
            }
            ...
            if (questionInfo.selectAnswer.contains(B)) {
                ...
                if (questionInfo.answer.contains(B) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_b_n_day), null, null, null);
                }
            }
            ...
            if (questionInfo.selectAnswer.contains(C)) {
                ...
                if (questionInfo.answer.contains(C) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_c_n_day), null, null, null);
                }
            }
            ...
            if (questionInfo.selectAnswer.contains(D)) {
                ...
                if (questionInfo.answer.contains(D) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_d_n_day), null, null, null);
                }
            }
            ...
            if (questionInfo.selectAnswer.contains(E)) {
                ...
                if (questionInfo.answer.contains(E) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_e_n_day), null, null, null);
                }
            }
            ...
            if (questionInfo.selectAnswer.contains(F)) {
                ...
                if (questionInfo.answer.contains(F) && questionInfo.wrongModel != 3) {
                    ...
                    viewWrapper.text.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_f_n_day), null, null, null);
                }
            }
        }
        return view;
     ...
     * @param selectAs selectAs
     * @param rightAs  rightAs
     */
        ...
        if (rightAs.contains(check)) {
            if (selectAs.contains(check)) {
                textView.setCompoundDrawablesWithIntrinsicBounds(
                        ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_true_day), null, null, null);
                textView.setTextColor(ContextCompat.getColor(activity, R.color.rightAnswer));
            } else {
                if (questionInfo.typeid.equals("2")) {
                    //没有选择该选项
                    textView.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_true_day), null, null, null);
                    textView.setTextColor(ContextCompat.getColor(activity, R.color.wrongAnswer));
                } else {
                    //没有选择该选项
                    textView.setCompoundDrawablesWithIntrinsicBounds(
                            ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_true_day), null, null, null);
            ...
            if (selectAs.contains(check)) {
                //但是选择了该选项
                textView.setCompoundDrawablesWithIntrinsicBounds(
                        ContextCompat.getDrawable(activity, R.drawable.jiakao_practise_false_day), null, null, null);
                textView.setTextColor(ContextCompat.getColor(activity, R.color.wrongAnswer));
            }
        }
    }
