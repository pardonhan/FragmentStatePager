 ...
 *      判断题模块
 */
public class SpecialTypeJudgeActivity extends BaseActivity {
    private final String type_id = "3";
    ...
    private void getExamData() {
        if(m_Dialog!=null){
            ...
            m_Dialog = MsgUtil.ShowLoadDialog(SpecialTypeJudgeActivity.this, "请稍后","正在加载数据...");
        }
        new Thread() {
            @Override
            public void run() {
                ...
                _List = DataBaseUtils.getRandomQuestionInfo(SpecialTypeJudgeActivity.this, type_id, exam_type);
                if (_List.size() > 0) {
