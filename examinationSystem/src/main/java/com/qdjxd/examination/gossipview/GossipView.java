...
public class GossipView extends View {
    ...
    private void init(Context c, AttributeSet attrs, int defStyle) {
        ...
        mOuterTextPaint.setTextSize(outArctrokeWidth / 10);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mTextStr, getOriginal().x - txWidth / 2, getOriginal().y + txHeight / 2, mNumberTextPaint);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mOuterTextPaint.setTextSize(outArctrokeWidth / 4);
